...
//
// mbr.Table implements the Table interface in github.com/ncw/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/ncw/go-diskfs package,
