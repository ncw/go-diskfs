...
func (sb *superblock) toBytes() ([]byte, error) {
	...
	binary.LittleEndian.PutUint32(b[0x18:0x1c], (uint32).math.Log2(sb.blockSize)-10)
	binary.LittleEndian.PutUint32(b[0x1c:0x20], (uint32).math.Log2(sb.clusterSize))
	...
	binary.LittleEndian.PutUint32(b[0x2c:0x30], sb.mountTime.Unix())
	binary.LittleEndian.PutUint32(b[0x30:0x34], sb.writeTime.Unix())
	...
	binary.LittleEndian.PutUint32(b[0x40:0x44], sb.lastCheck.Unix())
...
// groups.
func calculateBackupSuperblocks(numblocks, blocksPerBG int64) map[in64]bool{} {
